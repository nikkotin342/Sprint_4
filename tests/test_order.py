...
@allure.title('Создание заказа с проверкой и дальнейший переход по ссылкам')
class TestOrder():
    ...
    def test_order_button_top(self, driver, phone, name, surname, city):
        ...
        order_page.order(LocatorsMainPage.SEARCH_ORDER_BUTTON_TOP,
                         LocatorsOrderPage.SEARCH_NAME_FIELD,name,
                         LocatorsOrderPage.SEARCH_SURNAME_FIELD,surname,
                         LocatorsOrderPage.SEARCH_CITY_FIELD,city,
                         LocatorsOrderPage.SEARCH_METRO_FIELD,
                         LocatorsOrderPage.SEARCH_METRO_BUTTON,
                         LocatorsOrderPage.SEARCH_PHONE_NUMBER_FIELD,phone,
                         LocatorsOrderPage.SEARCH_CONTINUE_BUTTON,
                         LocatorsOrderPage.SEARCH_DATA_FIELD,
                         LocatorsOrderPage.SEARCH_DAY_BUTTON,
                         LocatorsOrderPage.SEARCH_RENT_FIELD,
                         LocatorsOrderPage.SEARCH_COUNT1_RENT_BUTTON,
                         LocatorsOrderPage.SEARCH_COLOUR1_FIELD,
                         LocatorsOrderPage.SEARCH_ORDER_BUTTON,
                         LocatorsOrderPage.SEARCH_YES_BUTTON,
                         LocatorsOrderPage.SEARCH_STATUS_BUTTON)
    ...
    def test_order_button_bottom(self, driver, phone, name, surname, city):
        ...
        order_page.order(LocatorsMainPage.SEARCH_ORDER_BUTTON_TOP,
                         ...
                         LocatorsOrderPage.SEARCH_DAY_BUTTON,
                         LocatorsOrderPage.SEARCH_RENT_FIELD,
                         LocatorsOrderPage.SEARCH_COUNT2_RENT_BUTTON,
                         LocatorsOrderPage.SEARCH_COLOUR2_FIELD,
                         LocatorsOrderPage.SEARCH_ORDER_BUTTON,
                         LocatorsOrderPage.SEARCH_YES_BUTTON,
                         LocatorsOrderPage.SEARCH_STATUS_BUTTON)
        assert order_page.find_element_with_wait(LocatorsStatusPage.SEARCH_STATUS_ORDER_FIELD)
