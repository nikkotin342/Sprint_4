...
class LocatorsOrderPage:
    SEARCH_NAME_FIELD = [By.XPATH, '//div/div[2]/div[2]/div[1]/input'] # Поле "Имя"
    SEARCH_SURNAME_FIELD = [By.XPATH, '//div/div[2]/div[2]/div[2]/input'] # Поле "Фамилия"
    SEARCH_CITY_FIELD = [By.XPATH, '//div/div[2]/div[2]/div[3]/input'] # Поле "Город"
    ...
    SEARCH_PHONE_NUMBER_FIELD = [By.XPATH, '//div/div[2]/div[2]/div[5]/input'] # Поле "Номер телефона"
    SEARCH_CONTINUE_BUTTON = [By.XPATH, '//*[contains(@class,"Button_Middle")]'] # Кнопка "Далее"
    SEARCH_DATA_FIELD = [By.XPATH, '//div/div[2]/div[2]/div[1]/div[1]/div/input'] # Поле "Когда привезти"
